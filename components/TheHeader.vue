...
//composable useToggleMenu

const basicMenu =ref(null);

const handleClickOutside=()=>{
  const isDispaybasicMenu = !basicMenu.value.classList.contains('hidden');
  if(isDispaybasicMenu){
  ...
  <header class="bg-white">
    ...
    <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
      ...
      <div class="hidden lg:flex lg:gap-x-12">
        ...
        <nav class="relative" >
          <button
            @click.stop.prevent="useToggleMenu(basicMenu)"
            type="button" 
            aria-expanded="false"
          ...
          -->
          <section
            name="menu_basic_nuxt_3"
            ref="basicMenu"
            class="absolute -left-8 border-2 top-full z-10 mt-3 w-screen max-w-md overflow-hidden 
              rounded-3xl bg-white shadow-lg ring-1 ring-gray-900/5"
          >
            <ul class="p-4" >
              <!-- First item in menu -->
              <li class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm leading-6 hover:bg-gray-50">
                ...
                <div class="flex-auto">
                  <NuxtLink href="/install-nuxt" class="block font-semibold text-gray-900">
                    Install Nuxt 3
